...
export default class StarScren extends Component {
  ...
  componentDidMount() {
    ...
    this.getStarDetails(name); //name is a parameter.
  }
  ...
  render() { //displaying the star name, mass, gravity, radius and distance from the Earth.  
...
const styles = StyleSheet.create({
  ...
  starName: {
    fontSize: RFValue(40), //responsive font-size
    fontWeight: "bold",
    textAlign: "center",
    color: "#fff"
  },
  ...
  lowerContainer: {
    flex: 0.15,
    backgroundColor: "#151F39", //hexadecimal number system
    justifyContent: "center",
    alignItems: "center"
  }
});
